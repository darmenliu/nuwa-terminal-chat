...
func PrintHelp(flags *CommandFlags) {
	...
	if flags.help {
		...
		fmt.Println("  Ctrl+C    Switch to Chat mode")
		fmt.Println("  Ctrl+F    Switch to Command mode")
		fmt.Println("  Ctrl+S    Switch to Task mode")
		fmt.Println("  Ctrl+A    Switch to Agent mode")
